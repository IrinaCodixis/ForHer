...
<html>
	...
	<body>
		...
		<div class="page">
			...
			<span id="title">Change Delivery Information </span>
			</div>
...
<?php
				...
				$select_db = @mysql_select_db($mysql_db, $con);
					...
					{
				$insert = "UPDATE customers SET fName='$field1', lName='$field2', street='$field3', city='$field4', zipcode='$field5', country='$field6', email='$field7'
